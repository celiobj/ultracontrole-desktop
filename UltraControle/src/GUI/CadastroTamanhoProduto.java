 ...
 * @author celiobj
 */
public class CadastroTamanhoProduto extends JPanel {
        ...
        acaoSalvar = (ActionEvent e) -> {
            ...
            if (resposta == 0) {
                if (tNome.getText().equalsIgnoreCase("")) {
                    ...
                    tamanhoProduto.setDescricao(tNome.getText());
                    repositorioTamanho.adcionar(tamanhoProduto);
                }
                try {
                    tNome.setText("");
                    atualizarTabela();
    ...
    public void atualizarTabela() {
        ...
        itensTable = repositorioTamanho.listarTodos(tNome.getText());
