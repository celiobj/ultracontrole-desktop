 ...
 * @author celiobj
 */
public class CadastroTipoProduto extends JPanel {
        ...
        acaoSalvar = (ActionEvent e) -> {
            ...
            if (resposta == 0) {
                if (tNome.getText().equalsIgnoreCase("")) {
                    ...
                    tipoProduto.setDescricao(tNome.getText());
                    repositorioTipo.adcionar(tipoProduto);
                }
                try {
                    tNome.setText("");
                    atualizarTabela();
    ...
    public void atualizarTabela() {
        ...
        itensTable = repositorioTipo.listarTodos(tNome.getText());
