 ...
 * @author celiobj
 */
public class CadastroFormadePagamento extends JPanel {
        ...
        acaoSalvar = (ActionEvent e) -> {
            ...
            if (resposta == 0) {
                if (tNome.getText().equalsIgnoreCase("")) {
                    ...
                    formaPagamento.setDescricao(tNome.getText());
                    repositorioFormaPagamento.adcionar(formaPagamento);
                }
                try {
                    tNome.setText("");
                    atualizarTabela();
    ...
    public void atualizarTabela() {
        ...
        itensTable = repositorioFormaPagamento.listarTodos(tNome.getText());
